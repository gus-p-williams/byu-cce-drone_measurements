...
- **Exam Structure:** 60 multiple-choice questions; 120 minutes; 70% passing score (42 correct).
- **Cost & Location:** Approximately $175 per attempt, taken at a PSI testing center.
- **Currency:** You must complete free recurrent online training every 24 months to maintain your certificate.

---

!!! tip "Essential Download — FAA Testing Supplement"
    During the actual Part 107 exam, you will be given a physical copy of the **Airman Knowledge Testing Supplement (FAA-CT-8080-2H)**. This book contains the exact sectional chart excerpts, airport diagrams, and weather reports used for the exam questions.

    **Crucial for Success:**
    - The versions linked below are **identical** to the one you will use during the test.
    - Students who are familiar with the supplement’s layout and know how to quickly find specific figures or legends perform significantly better.
    - Practice looking up legends, finding airport frequencies, and identifying airspace on the charts *before* you arrive at the testing center.
    ...
    **[Download local copy — FAA-CT-8080-2H (PDF, reduced resolution)](images/sport_rec_private_akts_FAA-CT-8080-2H_small.pdf)** | **[Official FAA source (full resolution)](https://www.faa.gov/training_testing/testing/supplements)**
    ...
    On the FAA page, look for the PDF titled **"FAA-CT-8080-2H"** under the *Pilots & Instructors* section. The local copy is compressed for convenience; use the FAA link for the high-resolution version needed to read small chart details.
