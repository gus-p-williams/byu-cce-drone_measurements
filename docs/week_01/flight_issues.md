...
| No home point, or very few satellites | Indoors, under cover, or close to buildings and trees | Wait, and move to open sky. Do not take off until the app confirms the home point is recorded. |
...
| Controller signal lost | Something between you and the aircraft, antennas pointed wrong, or simply too far | Raise altitude, turn so the flat faces of the antennas point at the aircraft. If it does not recover, let Return to Home run. |
| Return to Home starts on its own | Low battery, or lost signal | Let it run. Cancel only if it is heading somewhere unsafe, and then fly it back manually straight away. |
...
| Flight time much shorter than expected | Cold battery, wind, or high elevation and temperature | Warm batteries before flying, plan shorter legs, and land earlier than you think you need to. |
